/****************************************************************************
** Meta object code from reading C++ file 'viewer_window.hpp'
**
...
#include <memory>
#include "../../../../src/video_viewer_qt/include/video_viewer_qt/viewer_window.hpp"
#include <QtGui/qtextcursor.h>
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'viewer_window.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ViewerWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ViewerWindow_t qt_meta_stringdata_ViewerWindow = {
    {
QT_MOC_LITERAL(0, 12) // "ViewerWindow"
...
const QMetaObject ViewerWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ViewerWindow.offsetsAndSize,
    qt_meta_data_ViewerWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ViewerWindow_t
, QtPrivate::TypeAndForceComplete<ViewerWindow, std::true_type>
