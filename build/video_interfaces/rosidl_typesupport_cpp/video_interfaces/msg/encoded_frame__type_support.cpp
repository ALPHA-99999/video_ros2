...
static const _EncodedFrame_type_support_symbol_names_t _EncodedFrame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, video_interfaces, msg, EncodedFrame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, video_interfaces, msg, EncodedFrame)),
  }
};
...
{
  return &::video_interfaces::msg::rosidl_typesupport_cpp::EncodedFrame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, video_interfaces, msg, EncodedFrame)() {
  return get_message_type_support_handle<video_interfaces::msg::EncodedFrame>();
}
