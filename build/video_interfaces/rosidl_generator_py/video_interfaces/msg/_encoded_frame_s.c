...
bool video_interfaces__msg__encoded_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("video_interfaces.msg._encoded_frame.EncodedFrame", full_classname_dest, 48) == 0);
  }
  video_interfaces__msg__EncodedFrame * ros_message = _ros_message;
  {  // header
  ...
  {  // frame_size
    PyObject * field = PyObject_GetAttrString(_pymsg, "frame_size");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->frame_size = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // codec
    PyObject * field = PyObject_GetAttrString(_pymsg, "codec");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->codec, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of EncodedFrame */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("video_interfaces.msg._encoded_frame");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EncodedFrame");
  ...
  {  // frame_size
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->frame_size);
    {
      int rc = PyObject_SetAttrString(_pymessage, "frame_size", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // codec
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->codec.data,
      strlen(ros_message->codec.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "codec", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
