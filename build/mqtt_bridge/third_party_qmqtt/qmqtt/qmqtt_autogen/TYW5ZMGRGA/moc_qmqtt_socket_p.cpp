...
#include <memory>
#include "../../../../../../src/third_party_qmqtt/qmqtt/src/mqtt/qmqtt_socket_p.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QMQTT__Socket_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_QMQTT__Socket_t qt_meta_stringdata_QMQTT__Socket = {
    {
QT_MOC_LITERAL(0, 13) // "QMQTT::Socket"
...
const QMetaObject QMQTT::Socket::staticMetaObject = { {
    ...
    qt_meta_stringdata_QMQTT__Socket.offsetsAndSize,
    qt_meta_data_QMQTT__Socket,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QMQTT__Socket_t
