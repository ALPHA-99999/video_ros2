...
#include <memory>
#include "../../../../../../src/third_party_qmqtt/qmqtt/src/mqtt/qmqtt_ssl_socket_p.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QMQTT__SslSocket_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_QMQTT__SslSocket_t qt_meta_stringdata_QMQTT__SslSocket = {
    {
QT_MOC_LITERAL(0, 16) // "QMQTT::SslSocket"
...
const QMetaObject QMQTT::SslSocket::staticMetaObject = { {
    ...
    qt_meta_stringdata_QMQTT__SslSocket.offsetsAndSize,
    qt_meta_data_QMQTT__SslSocket,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QMQTT__SslSocket_t
, QtPrivate::TypeAndForceComplete<SslSocket, std::true_type>
