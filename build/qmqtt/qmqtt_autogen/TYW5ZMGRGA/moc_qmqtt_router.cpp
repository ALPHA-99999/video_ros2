...
#include <memory>
#include "../../../../src/third_party_qmqtt/qmqtt/src/mqtt/qmqtt_router.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QMQTT__Router_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_QMQTT__Router_t qt_meta_stringdata_QMQTT__Router = {
    {
QT_MOC_LITERAL(0, 13) // "QMQTT::Router"
...
const QMetaObject QMQTT::Router::staticMetaObject = { {
    ...
    qt_meta_stringdata_QMQTT__Router.offsetsAndSize,
    qt_meta_data_QMQTT__Router,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QMQTT__Router_t
, QtPrivate::TypeAndForceComplete<Router, std::true_type>
